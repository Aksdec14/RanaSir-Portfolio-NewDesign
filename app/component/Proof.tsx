...
const TESTIMONIALS = [
    {
        quote:
            "He came in when we were scaling fast and losing control of the back end. Within months, the chaos had a system — and it held.",
        name: "Founder & CEO",
        role: "SaaS Scale-up",
    },
    {
        quote:
            "I've worked with a lot of operators. Few can walk the floor, read a room, and fix the process in the same afternoon.",
        name: "Group CEO",
        role: "Multi-entity Holding Company",
    },
    {
        quote:
            "He found the real bottleneck — not the one in our dashboards, the one no one wanted to name. Then he fixed it.",
        name: "COO Peer",
        ...
        <section className="bg-stone-100 px-4 py-24 sm:px-6">
            <div className="mx-auto max-w-7xl text-left">
                ...
                <h2 className="mt-3 max-w-3xl text-3xl font-extrabold leading-tight tracking-tight text-neutral-900 sm:text-4xl">
                    Twenty-five years of taking broken things and making them
                    work.
                </h2>
